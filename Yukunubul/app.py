...
def ana_sayfa():
    ...
    # 📊 %100 GERÇEK SAYAÇLAR (Yapay sayılar kökten temizlendi)
...
def kayit_ol():
    if request.method == 'POST':
        ...
        # Reklam ve SMS izin kontrolü (Seçildiyse True, seçilmediyse False olur)
        ...
        yeni_kullanici = {
            ...
            "sms_eposta_izin": sms_pazarlama, # Reklam/Pazarlama İzni burada tutuluyor
            "onayli_mi": True,
            "bakiye": 0.0
        }
        
        kullanicilar.append(yeni_kullanici)
        verileri_yaz(KULLANICI_DOSYASI, kullanicilar) # Dosyaya kalıcı yazıldı!
...
def admin_paneli():
    ...
    # Kasa hesabı için tamamlananları toplayalım
